...
This is a known issue that still has no solution in GraphQL.js core, although, many community members tried to [propose solutions with working pull requests](https://github.com/graphql/graphql-js/issues/894) that alter the `subscribe` function.
