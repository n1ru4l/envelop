...
With [new major version](https://github.com/n1ru4l/envelop/pull/1487) comes breaking changes. This
section will guide you through the process of migrating from `v2` to `v3`.
...
[provide a new plugin](https://github.com/n1ru4l/envelop/pull/1500) that will let you hook into this
phase.
