...
As a plugin developer, you can define the `context` properties you are contributing. This will make sure to follow across execution of your plugin, and you can leverage type-safety across all hooks.
