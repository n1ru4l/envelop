...
Companies such as Klarna build their GraphQL server framework unsing Envelop.

Open-Source frameworks such as RedwoodJS (The JS App Framework for Startups) use Envelop.

Envelop can be used as meta-framework for building more high-level frameworks.
