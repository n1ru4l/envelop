...
Companies such as Klarna started building their GraphQL server framework unsing Envelop. Open-Source frameworks such as RedwoodJS (The JS App Framework for Startups) use Envelop. Envelop can be used as meta-framework for building high-level frameworks.
