...
After an `envelop` has been created, you can share it with others as a complete plugins layer. This is useful if you wish to create a predefined layer of plugins and share it with others. In addition, you can use it as a shell and as a base for writing shareable pieces of servers.
