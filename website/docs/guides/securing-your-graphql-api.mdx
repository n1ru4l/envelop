...
[Learn more about `graphql-inspector audit` here](https://www.the-guild.dev/graphql/inspector/docs/essentials/audit).
...
A handy tool for analyzing your existing GraphQL operations and finding the best defaults is [`graphql-inspector`](https://www.the-guild.dev/graphql/inspector).
