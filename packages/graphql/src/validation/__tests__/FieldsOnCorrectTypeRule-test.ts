...
describe('Validate: Fields on correct type', () => {
  ...
  describe('Fields on correct type error message', () => {
    ...
    it('Works with no suggestions', () => {
      ...
      expectErrorMessage(schema, '{ t { f } }').toEqual('Cannot query field "f" on type "T".');
    });
    ...
    it('Works with no small numbers of type suggestions', () => {
      ...
      expectErrorMessage(schema, '{ t { f } }').toEqual(
    ...
    it('Works with no small numbers of field suggestions', () => {
      ...
      expectErrorMessage(schema, '{ t { f } }').toEqual('Cannot query field "f" on type "T". Did you mean "y" or "z"?');
    });
    ...
    it('Sort type suggestions based on inheritance order', () => {
      ...
      expectErrorMessage(interfaceSchema, '{ t { foo } }').toEqual(
      ...
      expectErrorMessage(unionSchema, '{ catOrDog { name } }').toEqual(
