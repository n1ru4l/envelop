...
import type { SchemaDefinitionNode, SchemaExtensionNode } from '../language/ast';
...
import { getNamedType, isInputObjectType, isInterfaceType, isObjectType, isUnionType } from './definition';
import type { GraphQLDirective } from './directives';
import { isDirective, specifiedDirectives } from './directives';
import { __Schema, SchemaMetaFieldDef, TypeMetaFieldDef, TypeNameMetaFieldDef } from './introspection';
  ...
  getField(parentType: GraphQLCompositeType, fieldName: string): GraphQLField<unknown, unknown> | undefined {
    switch (fieldName) {
      case SchemaMetaFieldDef.name:
        return this.getQueryType() === parentType ? SchemaMetaFieldDef : undefined;
      case TypeMetaFieldDef.name:
        return this.getQueryType() === parentType ? TypeMetaFieldDef : undefined;
...
function collectReferencedTypes(type: GraphQLType, typeSet: Set<GraphQLNamedType>): Set<GraphQLNamedType> {
