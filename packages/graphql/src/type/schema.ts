...
import type { SchemaDefinitionNode, SchemaExtensionNode } from '../language/ast.js';
...
import { getNamedType, isInputObjectType, isInterfaceType, isObjectType, isUnionType } from './definition.js';
