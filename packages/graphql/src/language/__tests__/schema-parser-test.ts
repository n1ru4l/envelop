...
function inputValueNode(name: unknown, type: unknown, defaultValue: unknown, loc: unknown) {
  return {
      ...
      definitions: [
        {
          ...
          directives: [],
          fields: [
            fieldNode(nameNode('world', { start: 15, end: 20 }), typeNode('String', { start: 22, end: 28 }), {
              start: 15,
              end: 28,
            }),
          ],
      ...
      definitions: [
        {
          ...
          directives: [],
          fields: [
            fieldNode(nameNode('world', { start: 22, end: 27 }), typeNode('String', { start: 29, end: 35 }), {
              start: 22,
              end: 35,
            }),
          ],
      ...
      definitions: [
        {
          ...
          directives: [],
          fields: [
            fieldNode(nameNode('field', { start: 35, end: 40 }), typeNode('String', { start: 42, end: 48 }), {
              start: 35,
              end: 48,
            }),
          ],
      ...
      definitions: [
        {
          ...
          directives: [],
          fields: [
            fieldNode(nameNode('field', { start: 30, end: 35 }), typeNode('String', { start: 37, end: 43 }), {
              start: 30,
              end: 43,
            }),
          ],
      ...
      definitions: [
        {
          ...
          name: nameNode('Hello', { start: 5, end: 10 }),
          description: undefined,
          interfaces: [typeNode('Wo', { start: 22, end: 24 }), typeNode('rld', { start: 27, end: 30 })],
          directives: [],
          fields: [
            fieldNode(nameNode('field', { start: 33, end: 38 }), typeNode('String', { start: 40, end: 46 }), {
              start: 33,
              end: 46,
            }),
          ],
      ...
      definitions: [
        {
          ...
          name: nameNode('Hello', { start: 10, end: 15 }),
          description: undefined,
          interfaces: [typeNode('Wo', { start: 27, end: 29 }), typeNode('rld', { start: 32, end: 35 })],
          directives: [],
          fields: [
            fieldNode(nameNode('field', { start: 38, end: 43 }), typeNode('String', { start: 45, end: 51 }), {
              start: 38,
              end: 51,
            }),
          ],
      ...
      definitions: [
        {
          ...
          name: nameNode('Hello', { start: 5, end: 10 }),
          description: undefined,
          interfaces: [typeNode('Wo', { start: 24, end: 26 }), typeNode('rld', { start: 29, end: 32 })],
          directives: [],
          fields: [
            fieldNode(nameNode('field', { start: 35, end: 40 }), typeNode('String', { start: 42, end: 48 }), {
              start: 35,
      ...
      definitions: [
        {
          ...
          name: nameNode('Hello', { start: 10, end: 15 }),
          description: undefined,
          interfaces: [typeNode('Wo', { start: 29, end: 31 }), typeNode('rld', { start: 34, end: 37 })],
          directives: [],
          fields: [
            fieldNode(nameNode('field', { start: 40, end: 45 }), typeNode('String', { start: 47, end: 53 }), {
              start: 40,
              end: 53,
            }),
          ],
      ...
      definitions: [
        {
          ...
          description: undefined,
          directives: [],
          values: [enumValueNode('WO', { start: 13, end: 15 }), enumValueNode('RLD', { start: 17, end: 20 })],
          loc: { start: 0, end: 22 },
        },
      ],
      loc: { start: 0, end: 22 },
      ...
      definitions: [
        {
          ...
          directives: [],
          fields: [
            fieldNode(nameNode('world', { start: 20, end: 25 }), typeNode('String', { start: 27, end: 33 }), {
              start: 20,
              end: 33,
            }),
          ],
      ...
      definitions: [
        {
          ...
          description: undefined,
          directives: [],
          types: [typeNode('Wo', { start: 14, end: 16 }), typeNode('Rld', { start: 19, end: 22 })],
          loc: { start: 0, end: 22 },
        },
      ],
      loc: { start: 0, end: 22 },
      ...
      definitions: [
        {
          ...
          description: undefined,
          directives: [],
          types: [typeNode('Wo', { start: 16, end: 18 }), typeNode('Rld', { start: 21, end: 24 })],
          loc: { start: 0, end: 24 },
        },
      ],
      loc: { start: 0, end: 24 },
