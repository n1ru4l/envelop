...
describe('Visitor', () => {
  ...
  it('n', () => {
    ...
    expect(visited).toEqual([
      ...
      ['leave', 'Name', 'name', 'Field'],
      ['enter', 'NonNullAssertion', 'nullabilityAssertion', 'Field'],
      ['enter', 'ListNullabilityOperator', 'nullabilityAssertion', 'NonNullAssertion'],
      ['leave', 'ListNullabilityOperator', 'nullabilityAssertion', 'NonNullAssertion'],
      ['leave', 'NonNullAssertion', 'nullabilityAssertion', 'Field'],
      ...
      ['enter', 'NonNullAssertion', 'nullabilityAssertion', 'ListNullabilityOperator'],
      ['leave', 'NonNullAssertion', 'nullabilityAssertion', 'ListNullabilityOperator'],
      ...
      ['leave', 'Name', 'name', 'Field'],
      ['enter', 'ErrorBoundary', 'nullabilityAssertion', 'Field'],
      ['enter', 'ListNullabilityOperator', 'nullabilityAssertion', 'ErrorBoundary'],
      ['leave', 'ListNullabilityOperator', 'nullabilityAssertion', 'ErrorBoundary'],
      ['leave', 'ErrorBoundary', 'nullabilityAssertion', 'Field'],
      ...
      ['leave', 'Name', 'name', 'Field'],
      ['enter', 'ListNullabilityOperator', 'nullabilityAssertion', 'Field'],
      ['enter', 'ErrorBoundary', 'nullabilityAssertion', 'ListNullabilityOperator'],
      ['leave', 'ErrorBoundary', 'nullabilityAssertion', 'ListNullabilityOperator'],
      ['leave', 'ListNullabilityOperator', 'nullabilityAssertion', 'Field'],
