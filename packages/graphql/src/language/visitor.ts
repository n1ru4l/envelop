 ...
 */
export function visitInParallel(visitors: ReadonlyArray<ASTVisitor>): ASTVisitor {
...
export function getEnterLeaveForKind(visitor: ASTVisitor, kind: Kind): EnterLeaveVisitor<ASTNode> {
  const kindVisitor: ASTVisitFn<ASTNode> | EnterLeaveVisitor<ASTNode> | undefined = (visitor as any)[kind];
