...
import type { DocumentNode, FieldNode, FragmentDefinitionNode, OperationDefinitionNode } from '../language/ast';
...
import { collectFields, collectSubfields as _collectSubfields } from './collectFields';
