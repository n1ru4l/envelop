...
import type { GraphQLSchemaNormalizedConfig, GraphQLSchemaValidationOptions } from '../type/schema.js';
...
export function extendSchemaImpl(
  ...
  function extendField(field: GraphQLFieldConfig<unknown, unknown>): GraphQLFieldConfig<unknown, unknown> {
    return {
      ...field,
      type: replaceType(field.type),
  ...
  function getOperationTypes(nodes: ReadonlyArray<SchemaDefinitionNode | SchemaExtensionNode>): {
