  ...
  enter(node: ASTNode) {
    ...
    switch (node.kind) {
      ...
      case Kind.LIST: {
        ...
        const itemType: unknown = isListType(listType) ? listType.ofType : listType;
...
function getFieldDef(schema: GraphQLSchema, parentType: GraphQLCompositeType, fieldNode: FieldNode) {
