...
import type { GraphQLFieldConfig, GraphQLFieldConfigMap, GraphQLNamedType, GraphQLType } from '../type/definition.js';
import {
  assertInterfaceType,
  assertNullableType,
  assertObjectType,
...
export function buildClientSchema(
  ...
  function buildField(fieldIntrospection: IntrospectionField): GraphQLFieldConfig<unknown, unknown> {
  ...
  function buildDirective(directiveIntrospection: IntrospectionDirective): GraphQLDirective {
