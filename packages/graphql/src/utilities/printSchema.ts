...
import { DEFAULT_DEPRECATION_REASON, isSpecifiedDirective } from '../type/directives';
...
function printArgs(args: ReadonlyArray<GraphQLArgument>, indentation: string = ''): string {
  ...
  return (
    '(\n' +
    args
      .map((arg, i) => printDescription(arg, '  ' + indentation, !i) + '  ' + indentation + printInputValue(arg))
      .join('\n') +
    '\n' +
    indentation +
    ')'
